...
class __TwigTemplate_68505bba45ac61d6f830d7cdcea7fba20b8a0df69daf47662df6035db2ac9779 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25))) ? (("slick-wrapper--tn-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "thumbnail_position", [], "any", false, false, true, 25), 25, $this->source), ["over-" => ""]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "modules/slick/templates/slick-wrapper.html.twig", "C:\\laragon\\www\\drupal\\modules\\slick\\templates\\slick-wrapper.html.twig");
    }
